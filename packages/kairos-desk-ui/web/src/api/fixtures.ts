  ...
  projects: [
    {
      ...
      blocker: "4 tasks need attention",
      cards: [
        {
          kind: "work-card",
        ...
        },
        {
          ...
          status: "blocked",
          owner: "cindy",
          summary: "Cindy needs the diff review decision before closing the quality pass on validation and edge cases.",
          projectId: "project-fibonacci-cli",
          diffSummary: null,
          patchSetIds: [],
        },
        {
          kind: "work-card",
          id: "card-error-copy",
          title: "Resolve CLI error output copy",
          phase: "Review",
          status: "failed",
          owner: "alice",
          summary: "The failed run evidence points at confusing stderr text for invalid Fibonacci input.",
          projectId: "project-fibonacci-cli",
          diffSummary: null,
          patchSetIds: [],
        },
